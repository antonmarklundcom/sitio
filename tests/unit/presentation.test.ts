...
describe("presentationLabel", () => {
  it("skriver tema, variant och accent på spanska", () => {
    expect(presentationLabel("servicios")).toBe("servicios · variante 2 (azul)");
    expect(presentationLabel("belleza")).toBe("salud · variante 2 (orquídea)");
  });
