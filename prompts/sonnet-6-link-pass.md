# Phase S6 — Link pass. Sonnet session. Sequential, after S1–S5 are merged.
...
`src/themes/{servicios,gastronomia,salud,belleza,taller}/*-theme.tsx`,
...
- Steps exactly as plan §6.4, in order. No new features; a missing feature is
  a §10 line.
- Full QA gate for all six themes once; full `npm run smoke` once against
...
Exit: products section renders in all six themes when the module is on
(smoke or screenshot); QA gate green ×6; smoke green end to end;
